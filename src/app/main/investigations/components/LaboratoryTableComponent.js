...
const LaboratoryTableComponent = props => {
	const [inputList, setInputList] = useState([{ date: '', test: '', results: '', units: '' }]);
	...
	const handleAddClick = () => {
		setInputList([...inputList, { date: '', test: '', results: '', units: '' }]);
	};
...
export default LaboratoryTableComponent;
