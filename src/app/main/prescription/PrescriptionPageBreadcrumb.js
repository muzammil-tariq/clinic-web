...
function PrescriptionPageBreadcrumb({ className }) {
	const { pathname } = useLocation();
	const pathArr = getPathTree(PrescriptionNavigation, pathname);

	return (
		<div className={clsx('', className)}>
			<Breadcrumbs aria-label="breadcrumb">
				<Link className="font-bold hover:underline" color="secondary" to="/prescription" role="button">
					Prescription
				</Link>
				{pathArr.map(item => (
...
export default PrescriptionPageBreadcrumb;
